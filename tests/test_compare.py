...
def test_mol():
    ...
    mol_1 = chimera.openModels.open(os.path.join(path, "data/mol1.pdb"), type="PDB")[0]
    mol_2 = chimera.openModels.open(os.path.join(path, "data/mol2.pdb"), type="PDB")[0]
    mol_3 = chimera.openModels.open(os.path.join(path, "data/mol3.pdb"), type="PDB")[0]
